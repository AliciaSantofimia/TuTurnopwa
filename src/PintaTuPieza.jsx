...
export default function PintaTuPieza() {
  ...
  const nombreClase = String(
    datosClase?.nombre || "Pinta tu pieza de cerámica"
  );
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-0">
          ...
          <div className="p-4 sm:p-6 flex flex-col justify-start min-w-0">
            <div className="flex flex-col gap-3 mb-4">
              ...
              {!desdeGrupos && (
                <BotonReserva destino="/reserva-pinta-tu-pieza" className="self-start" />
              )}
            </div>
            ...
            <div className="mb-5 min-w-0">
              ...
              <div className="bg-[#fffaf0] border-l-4 border-[#F4C542] rounded-xl p-4 mb-4">
                <p className="text-sm text-gray-700 italic leading-relaxed break-words">
                  ...
                  bandejas. Si prefieres combinar dos pequeñas o elegir una de
                  mayor valor, solo tendrás que abonar la diferencia.
                </p>
              </div>
