...
const CLASE_ID = "tazaescultorica";
const RESERVAS_PATH_KEY = "CreaTuTazaEscultorica";
...
export default function ReservaCreaTuTazaEscultorica() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const reserva = {
        clase: claseConfig?.nombre || "Crea tu taza escultórica",
        claseId: CLASE_ID,
    ...
    <div className="bg-[#fffef4] min-h-screen flex items-center justify-center px-4 py-8">
      <div className="bg-white max-w-md w-full rounded-2xl shadow-md p-6">
        ...
        <h1 className="text-center text-2xl text-[#5c3c00] font-serif mb-4">
          Reserva – {claseConfig?.nombre || "Crea tu taza escultórica"}
        </h1>
