...
export default function ReservaTornoAlfareroPerfeccionaLoQueYaSabes() {
  ...
  const precioBase = 145;
  const precioTotal = 145;
  ...
  timestamp: new Date().toISOString(),
      ...
      const generalRef = ref(
        dbRealtime,
        `reservas/TornoAlfareroPerfeccionaLoQueYaSabes/${fechaInicio}/${turno}`
      );
    ...
    <div className="bg-[#fffef4] min-h-screen flex items-center justify-center px-4 py-8">
      <div className="bg-white max-w-md w-full rounded-2xl shadow-md p-6">
        ...
        <h1 className="text-center text-2xl text-[#5c3c00] font-serif mb-4">
          Reserva – Torno alfarero perfecciona lo que ya sabes
        </h1>
        ...
        <BloqueoReserva>
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="bg-[#fffaf0] border border-[#f1e7c6] rounded-xl p-3 text-sm text-[#5c3c00]">
              <p><strong>Curso de 6 clases.</strong></p>
              <p>
                Incluye 6 sesiones de 3 horas centradas exclusivamente en torno
            ...
            <div className="bg-[#fffaf0] border border-[#f1e7c6] rounded-xl p-3 text-sm text-[#5c3c00]">
              ...
              <p>
                <strong>Clases incluidas:</strong> 6 sesiones de 3 horas
              </p>
              <p>
            ...
            {fechaInicio && (
              <div className="bg-[#fffaf0] border border-[#f1e7c6] rounded-xl p-3 text-sm text-[#5c3c00]">
                <p><strong>Precio total:</strong> 145€</p>
                <p>
